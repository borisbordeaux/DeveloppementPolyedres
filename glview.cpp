...
static const char *fragmentShaderSource =
        ...
        "   highp vec3 color = vec3(0.4, 1.0, 0.0);\n"
...
void GLView::initializeGL()
{
    ...
    //to not see the invisible faces
    //glEnable(GL_CULL_FACE);
    //for translucent faces
    //glEnable(GL_BLEND);
    ...
    m_camera.lookAt(QVector3D(0.0f,0.0f,7.0f), QVector3D(0.0f,0.0f,0.0f), QVector3D(0.0f,1.0f,0.0f));
